...
def main():
    ...
    parser.add_argument('--max-voxels', type=int, default=100000, help='Per-submap read limit (match recording configuration)')
    parser.add_argument('--max-input-points', type=int, default=200000, help='Per-keyframe read limit')
    ...
    try:
        if args.operation == 'inspect':
            ...
            print(json.dumps({'exported_points': store.export_pcd(args.destination)}))
    finally:
        store.close()
